...
<footer>
<br><br><br>URL Station (Generation) 1.0.6<br>
</footer>
</body>
</html>
"""
...
class CopyButton(ft.Row):
    ...
    def get_format_all(self):
        if self.copy_body.value == "" or self.show_text.value == "":
            return []
        return [
            f"""<button onclick="clipping('{escape_quorts(double_backslash(sunitize(self.copy_body.value)))}')">{sunitize(self.show_text.value)} <i class="fa-regular fa-copy"></i></button><br>"""
            + "\n"
        ]
